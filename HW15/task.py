...
def add():
    ...
    if founded_info:
        ...
        check_number_pattern = re.compile(r"^(?:\+?380|0)\d{9}$")
        # ==== I found in documentation useful expression - (?:...)
        ...
        match = re.fullmatch(check_number_pattern, user_number)
        if match:
            ...
            print("You've entered your number with a wrong format.")
